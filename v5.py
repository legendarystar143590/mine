...
def generate_initial_solution(problem_statement: str, code_skeleton: str, function_metadata: dict = None) -> str:
    ...
    while retry < 5:
        try:
            ...
            loop_check_response = EnhancedNetwork.make_request(loop_check_messages, model=QWEN_MODEL_NAME, temperature=1.0)
...
def generate_test_code(problem_statement: str, code_skeleton: str, function_metadata: dict = None) -> str:
    ...
    while retry < 10:
        try:
            testcode_response = EnhancedNetwork.make_request(test_generation_messages, model=QWEN_MODEL_NAME, temperature=1.0)
