...
Always think which step are you in and what is success criteria for that step and add in next_thought field.
...
2. **Error Handling Format**:
   - For errors: 
     next_thought: "Step 1: Error: [detailed explanation]"
     next_tool_name: ""
     next_tool_args: {}

3. **Example Valid Format**:
   next_thought: "Step 1: I'll fix the JSON parsing issue by adding proper error handling and validation"
...
##  File Reading and Writing Rules:
- Added line numbers to the content of the file to help you understand the context of the code.
- Don't generate line numbers in your response except for start line and end line
- After writing the content to the file, always check the content of the file and make sure it's correct.
    ...
    def _get_file_content(self,file_path: str, search_start_line: int = None, search_end_line: int = None, search_term: str = None,limit:int=5000)->str:
        ...
        with open(file_path, "r") as f:
            if search_start_line is not None or search_end_line is not None:
                ...
                content = self._add_line_numbers_to_content(f.read())
