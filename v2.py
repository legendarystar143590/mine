...
<workflow_steps>
  <step number="1">
    ...
    <rules>
      ...
      - Check both source files and test files for context
    </rules>
  </step>
  ...
  <step number="2">
    ...
    <rules>
      ...
      - Understand the root cause by reading the code carefully
      - Identify all locations where similar issues might exist
  ...
  <step number="5">
    ...
    <rules>
      ...
      - Never edit/update the existing test files directly when validating a hypothesis
    </rules>
  </step>
  ...
  <step number="6">
    ...
    <rules>
      ...
      - Ensure the fix is robust and handles all corner cases
    </rules>
  </step>
...
<important_constraints>
  ...
  <constraint>Code must always be backward compatible unless explicitly mentioned otherwise in the problem statement</constraint>
  <constraint>Do not create any new files or directories unless absolutely necessary for the fix</constraint>
</important_constraints>
