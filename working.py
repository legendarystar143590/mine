...
def agent_main(input_dict: dict[str, Any], repo_dir: str = "repo", test_mode: bool = False):
    ...
    problem_statement = input_dict.get("problem_statement", "Problem Statement")
    logger.info("<blue>📑 Problem Statement:</blue>")
    logger.debug(f"{problem_statement[:200]}..............")
    
    result = solve_fix_task(problem_statement)
