...
FIX_TASK_SYSTEM_PROMPT = textwrap.dedent(
    ...
    14. **IMPORTANT**: At the end of each significant step, use the `save_context` tool to save a summary of what was accomplished, what was learned, and what the next steps should be. This helps maintain context across the debugging session.
...
class FixTaskEnhancedToolManager(EnhancedToolManager):
    ...
    def __init__(self, available_tools: Optional[list[str]] = [], test_runner: str = "pytest",
        ...
        self.context_summaries = []  # Store step-by-step context summaries
    ...
    @EnhancedToolManager.tool
    def save_context(self, step_summary: str, step_number: int = None):
        '''
        Saves a summary of the current step's work and findings for future reference
        Arguments:
            step_summary: A concise summary of what was done, what was found, and what decisions were made in this step
            step_number: Optional step number for tracking
        Output:
            Confirmation message indicating the context was saved
        '''
        context_entry = {
        ...
        self.context_summaries.append(context_entry)
        return f"Context saved for step {step_number if step_number else len(self.context_summaries)}: {step_summary[:100]}..."
